---
sidebar_position: 2
title: 上游参考：Codex 状态栏源码快照
description: 官方 Codex CLI 固定源码提交中的 28 个原生 status line 项目。
---
...
本文只记录官方 Codex CLI 固定提交 `d167a3604c404e4ee4bc5b5d0b7923e24e0f54f8` 的源码行为，不是本项目配置参考。当前插件公开 26 个 segment，见[配置参考](../guides/configuration.md#渲染与图标)。
